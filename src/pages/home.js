        ...
        <div className="home-container">
            <div className="sidebar">
                ...
                <ul>
                    ...
                    <li>
                        <NavLink to="payrollfinal" className={({ isActive }) => (isActive ? 'active' : '')}>
                ...
                {isStaffPage && !isAddStaffPage && !isEditStaffPage && (
                    <>
                        <div className="top-bar">
                            ...
                            <div className="search-ble-container">
                                <div className="search-bar-ble-container">
                                    <input
                                        type="text"
        ...
        <tr key={staff.StaffID}>
            ...
            <td>
                ...
                <button onClick={() => handleRemoveStaff(staff.StaffID)}>Remove</button>
                    ...
                    <Route path="payroll" element={<Navigate to="payrollfinal" />} />
                    <Route path="payrollfinal" element={<PayrollFinal />} />
